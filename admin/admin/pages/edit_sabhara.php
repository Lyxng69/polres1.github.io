        	...
        	<div class="row">
        		<div class="col-lg-12">
        			...
        			<div class="panel-body">
						...
						include "koneksi.php";
						$e = $_GET['id'];
						$edit = mysqli_query($conn, "SELECT * FROM tbl_sabhara WHERE id_sabhara='$e'");
        				...
        				<form action="?module=e_sabhara" method="post" enctype="multipart/form-data">
        					<input type="hidden" name="id_sabhara" class="form-control" value="<?php echo $book['id_sabhara']; ?>">
        					...
        					<td>
        						...
        						<b>Tujuan Pengawalan : </b><input type="text" name="tujuan_pengawalan" class="form-control" value="<?php echo $book['tujuan_pengawalan']; ?>"><br>
        						<b>Route : </b><input type="text" name="route" class="form-control" value=" <?php echo $book['route']; ?>"><br>
