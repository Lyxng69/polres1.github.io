...
include "koneksi.php"; 
include "tglindo.php"; 
$d = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM tbl_sim where id_sim='$_GET[id]'"));
?>
...
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$d[id_sim]"; ?>/198/TRANTIB/309.07/VIII/2022</p></td>
</tr> 
</table>
