        		...
        		<div class="col-lg-12">
        			...
        			<div class="panel-body">
        				...
        				<form method="post" class="form-group" action="tambah_skck.php" enctype="multipart/form-data" style="margin-top:20px;">
        					...
        					<input type="text" name="no_ktp" placeholder="No KTP" class="form-control"><br>
        					<input type="text" name="no_telp" placeholder="Nomor Telfon" class="form-control"><br>
        					<input type="text" name="keperluan" placeholder="Keperluan" class="form-control"><br>
        					<input type="text" name="riwayat_sekolah" placeholder="Riwayat Sekolah" class="form-control"><br>
