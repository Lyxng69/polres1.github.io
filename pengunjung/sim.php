...
<p align="center">&raquo;Input Data SIM&laquo;</p>
<table border="0px">
			<form method="post" class="form-group" action="tambah_sim.php" enctype="multipart/form-data">
			...
			<tr><td>Tinggi</td> <td>:</td><td><input name="tinggi"  size="25" class="texbox"></td></tr>
			<tr><td>No Hp(WA)</td> <td>:</td><td><input name="no_telp"  size="25" class="texbox"></td></tr>
			<tr><td>No Sim</td> <td>:</td><td><input name="no_sim"  size="25" class="texbox"></td></tr>
