...
<head>
  ...
  <!-- Bootstrap Core CSS -->
  <link href="/polres/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

  <!-- Custom CSS -->
  <link href="/polres/vendor/dist/css/sb-admin-2.css" rel="stylesheet">
...
<body class="size-1140">
        ...
        <ul class="right chevron">
          ...
          <li><a>Pelayanan</a>
            <ul>
              ...
              <li><a href="?module=kritik_saran">KRITIK & SARAN</a></li>
            </ul>
          </li>
  ...
  <main role="main">
            ...
            <div class="carousel-content">
              <div class="content-center-vertical line">
                <div class="margin-top-bottom-80">
                  <!-- Title -->
                  <h2 class="text-white margin-bottom-30 text-size-60 text-m-size-30 text-line-height-1"><br>Kepolisian Resor Pati<br>Republik Indonesia</h2>
    ...
    <?php
    include "content.php";
    include('../_kritik_saran_home.php')
    ?>
    ...
    <script src="/polres/vendor/jquery/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="/polres/vendor/bootstrap/js/bootstrap.min.js"></script>
