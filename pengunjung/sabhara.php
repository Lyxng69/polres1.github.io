...
<p align="center">&raquo;Input Data Sabhara&laquo;</p>
<table border="0px">
			<form method="post" class="form-group" action="tambah_sabhara.php" enctype="multipart/form-data">
			<tr><td>Nama</td> <td>:</td> <td><input name="nama" size="25" class="texbox"></td></tr>
			<tr><td>Tempat Lahir</td> <td>:</td> <td><input name="tmp_lahir" type="text" size="25" class="texbox"></td></tr>
			...
			<tr><td>No Hp(WA)</td> <td>:</td><td><input name="no_telp"  size="25" class="texbox"></td></tr>
			<tr><td>Tujuan Pengawalan</td> <td>:</td><td><input name="tujuan_pengawalan" size="25" class="texbox"></td></tr>
			<tr><td>Route</td> <td>:</td><td><input name="route"  size="25" class="texbox"></td></tr>
